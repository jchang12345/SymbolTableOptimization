...
const char* commandFileName = "/Users/justinchang/Desktop/CS32 FOLDER/CS32Project4/CS32Project4/commands.txt";
...
int main()
{
    ...
    assert(st.find("alpha") == 1);   // the alpha declared in line 1
    assert(st.find("beta") == 7);    // the beta declared in line 7
    st.enterScope();  // could swear, most recent line is most definitely not 10... , "technically" line 20.
